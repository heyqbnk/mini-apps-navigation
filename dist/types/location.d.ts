 ...
 */
export interface NavigatorTechLocation extends Pick<NavigatorLocation, 'modifiers'> {
}
/**
 * List of types that that represents complete location data
 */
export declare type NavigatorCompleteLocationType = NavigatorLocation | NavigatorTechLocation;
/**
 * List of all available navigator locations
 */
export declare type NavigatorLocationType = NavigatorLocation | NavigatorSimplifiedLocation | NavigatorTechLocation;
/**
 * Minimal set of required properties for navigator location
 */
export interface NavigatorSimplifiedLocation extends MakePartial<NavigatorLocation, 'modifiers' | 'params'> {
}
